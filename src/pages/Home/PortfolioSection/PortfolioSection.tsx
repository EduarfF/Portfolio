...
const PROJECTS: Project[] = [
  ...
  },
  {
    id: 3,
    category: "landings",
    description: "home_page.portfolio_section.projects.landing_shopify.description",
  ...
  },
  {
    ...
    stack: ["HTML", "HubSpot", "Outlook", "Gmail", "Icloud", "PixelPerfect", "ThunderBird", "w3validator"],
  },
  {
    id: 6,
    category: "emails",
    description: "home_page.portfolio_section.projects.email_klaviyo.description",
    image: "/images/img-06.webp",
    stack: ["HTML", "Klaviyo", "Outlook", "Gmail", "Icloud", "PixelPerfect", "ThunderBird", "w3validator"],
  },
  {
    id: 7,
    category: "emails",
    description: "home_page.portfolio_section.projects.email_customer.description",
    image: "/images/img-07.webp",
    stack: ["Customer.io", "HTML", "Outlook", "Gmail", "Icloud", "PixelPerfect", "ThunderBird", "w3validator"],
  },
  {
    id: 8,
    category: "emails",
    description: "home_page.portfolio_section.projects.email_mailchimp.description",
    image: "/images/img-08.webp",
    stack: ["Mailchimp", "HTML", "Outlook", "Gmail", "Icloud", "PixelPerfect", "ThunderBird", "w3validator"],
  },
  {
    id: 9,
    category: "emails",
    description: "home_page.portfolio_section.projects.email_active.description",
    image: "/images/img-09.webp",
    stack: ["Active Campaign", "HTML", "Outlook", "Gmail", "Icloud", "PixelPerfect", "ThunderBird", "w3validator"],
  },
];
...
const PortfolioSection: React.FC<PortfolioSectionProps> = ({ id }) => {
  ...
  const [activeTab, setActiveTab] = useState<"landings" | "emails">("landings");
        ...
        <div className="md:flex md:flex-row md:items-end justify-between gap-8 mb-6 md:mb-12">
          ...
          <div className="flex flex-col items-center">
            <div className="inline-flex p-1.5 bg-slate-200/50 dark:bg-slate-800/50 rounded-2xl border border-slate-300/30">
              {(["landings", "emails"] as const).map((tab) => (
                <button
                  key={tab}
                  onClick={() => {
                    setActiveTab(tab);
                  ...
                  className={`w-32.5 px-4 py-3 rounded-xl text-[14px] sm:text-sm font-bold transition-all duration-300 whitespace-nowrap ${
                    activeTab === tab
                      ? "bg-white dark:bg-slate-700  text-yellow-500"
                      : "text-slate-500 hover:text-slate-800 dark:hover:text-slate-200"
                  }`}
                >
                  {tab === "landings" ? "Landing Pages" : "Emails"}
                </button>
              ))}
            </div>
          </div>
